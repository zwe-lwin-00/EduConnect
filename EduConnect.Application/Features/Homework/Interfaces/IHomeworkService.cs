...
public interface IHomeworkService : IService
{
    ...
    Task<List<HomeworkDto>> GetHomeworksByTeacherAsync(int teacherId, int? studentId = null);
    ...
    Task<List<StudentGradeDto>> GetGradesByTeacherAsync(int teacherId, int? studentId = null);
